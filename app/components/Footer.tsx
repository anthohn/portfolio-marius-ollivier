    ...
    return (
        <>
            <footer className="flex flex-col p-10">
                <div className=' w-full flex flex-col md:flex-row pt-32 py-10 border-t-2 items-center mt-96'>
                    <h2 className={`${bodoni_moda.className} text-[40px] md:w-1/2 text-center md:border-r-[3px] px-4`}>MARIUS OLIVIER</h2>
                    <div className="w-1/2 flex flex-wrap md:space-x-14 md:px-4 justify-center text-sm" >
                        <div className='flex flex-col space-y-2'>
                            <div className='flex flex-col space-y-6 md:space-y-0 md:flex-row items-center md:space-x-4 list-none text-md p-6 md:p-0'>
                                {links.map(link => (
