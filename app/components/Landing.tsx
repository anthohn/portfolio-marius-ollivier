  ...
  return (
    <LandingContainer>
      <motion.h1
        ...
        className={`${bodoni_moda.className} bg-gradient-to-b from-red-400 to-white pb-40 pt-40 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent xl:text-[200px]`}
      >
        Marius Ollvier
      </motion.h1>
    </LandingContainer>
