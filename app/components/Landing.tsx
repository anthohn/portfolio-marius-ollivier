      ...
      <div className="h-[850px] md:h-screen max-h-[1000px] flex flex-col justify-between ">
        <div className="flex flex-col -space-y-80 2xl:-space-y-64  2xl:mt-10">
         ...
         <motion.h1
            ...
            viewport={{ once: true }}
            className={`${bodoni_moda.className} text-center text-[100px] md:leading-normal md:text-[105px] lg:text-[110px] xl:text-[130px] 2xl:text-[180px] bg-clip-text text-transparent bg-gradient-to-b from-red-300 to-white`}>
            Marius Ollivier
          </motion.h1>
        ...
        <motion.h1
            ...
            viewport={{ once: true }}
            className={`${bodoni_moda.className}  text-center italic leading-none md:leading-normal text-[30px] md:text-[32px] lg:text-[34px] xl:text-[36px] 2xl:text-[40px] bg-clip-text text-transparent bg-gradient-to-b from-red-300 to-white`}>
            Photographe Suisse
          </motion.h1>
        ...
        viewport={{ once: true }} className="flex justify-center md:justify-end m-10">
          <div className="flex flex-wrap space-x-5 md:space-x-10 items-center bg-red-500 bg-opacity-20 w-auto p-4 shadow-2xl shadow-red-500/40 border-2 border-btnBackground rounded-xl">
